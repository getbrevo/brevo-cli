...
- Create, list, upload changes to, or delete Brevo apps — OAuth apps, or UI apps (action links and modal iframe extensions rendering inside Brevo CRM records)
