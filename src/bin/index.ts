  ...
  .configureHelp({
    formatHelp: (_cmd, helper) => {
      ...
      return [
        ...
        `  brevo app create            [--name] [--type oauth|ui] [--distribution private|public]`,
        `                              [--redirect-uri <url>...] [--logo-uri <url>] [--json]`,
        `                                                        Create a new app (OAuth or UI app)`,
        ...
        `  brevo app remove            <account-id> [--app-id <id>] [--force] [--json]`,
        `                                                        Remove an app from an account`,
        ``,
