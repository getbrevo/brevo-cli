...
// a pty, init through scripted stdin), and the function suite is opt-in because
// it exercises read-only endpoints that may return empty results on a fresh account.
